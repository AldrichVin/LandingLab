...
const SHAPE_CONFIGS: readonly ShapeConfig[] = [
  { position: [-4, 2, -6], scale: 0.8, color: '#e0d4f0', speed: 0.15, offset: 0, geometry: 'sphere' },
  { position: [3, -1, -8], scale: 1.2, color: '#f0d8e8', speed: 0.12, offset: 1.5, geometry: 'sphere' },
  { position: [-2, -2.5, -5], scale: 0.6, color: '#f5e8d8', speed: 0.18, offset: 3, geometry: 'capsule' },
  { position: [5, 1.5, -10], scale: 1.0, color: '#d8d0f0', speed: 0.1, offset: 0.8, geometry: 'sphere' },
  { position: [-5, 0, -7], scale: 0.5, color: '#f0d0e0', speed: 0.2, offset: 2.2, geometry: 'capsule' },
  { position: [1, 3, -9], scale: 0.7, color: '#e0e0f8', speed: 0.14, offset: 4, geometry: 'sphere' },
  { position: [4, -2, -6], scale: 0.4, color: '#f5e0d0', speed: 0.22, offset: 5, geometry: 'sphere' },
];
